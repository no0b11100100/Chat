...
::grpc::Status Chat::Stub::readMessage(::grpc::ClientContext* context, const ::chat::ReadMessage& request, ::chat::Status* response) {
  return ::grpc::internal::BlockingUnaryCall< ::chat::ReadMessage, ::chat::Status, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_readMessage_, context, request, response);
}

void Chat::Stub::async::readMessage(::grpc::ClientContext* context, const ::chat::ReadMessage* request, ::chat::Status* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::chat::ReadMessage, ::chat::Status, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_readMessage_, context, request, response, std::move(f));
}

void Chat::Stub::async::readMessage(::grpc::ClientContext* context, const ::chat::ReadMessage* request, ::chat::Status* response, ::grpc::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::chat::Status>* Chat::Stub::PrepareAsyncreadMessageRaw(::grpc::ClientContext* context, const ::chat::ReadMessage& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::chat::Status, ::chat::ReadMessage, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_readMessage_, context, request);
}

::grpc::ClientAsyncResponseReader< ::chat::Status>* Chat::Stub::AsyncreadMessageRaw(::grpc::ClientContext* context, const ::chat::ReadMessage& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
::grpc::Status Chat::Stub::editChat(::grpc::ClientContext* context, const ::chat::ChatData& request, ::chat::Status* response) {
  return ::grpc::internal::BlockingUnaryCall< ::chat::ChatData, ::chat::Status, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_editChat_, context, request, response);
}

void Chat::Stub::async::editChat(::grpc::ClientContext* context, const ::chat::ChatData* request, ::chat::Status* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::chat::ChatData, ::chat::Status, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_editChat_, context, request, response, std::move(f));
}

void Chat::Stub::async::editChat(::grpc::ClientContext* context, const ::chat::ChatData* request, ::chat::Status* response, ::grpc::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::chat::Status>* Chat::Stub::PrepareAsynceditChatRaw(::grpc::ClientContext* context, const ::chat::ChatData& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::chat::Status, ::chat::ChatData, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_editChat_, context, request);
}

::grpc::ClientAsyncResponseReader< ::chat::Status>* Chat::Stub::AsynceditChatRaw(::grpc::ClientContext* context, const ::chat::ChatData& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
::grpc::Status Chat::Stub::sendMessage(::grpc::ClientContext* context, const ::chat::ExchangedMessage& request, ::chat::Status* response) {
  return ::grpc::internal::BlockingUnaryCall< ::chat::ExchangedMessage, ::chat::Status, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_sendMessage_, context, request, response);
}

void Chat::Stub::async::sendMessage(::grpc::ClientContext* context, const ::chat::ExchangedMessage* request, ::chat::Status* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::chat::ExchangedMessage, ::chat::Status, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_sendMessage_, context, request, response, std::move(f));
}

void Chat::Stub::async::sendMessage(::grpc::ClientContext* context, const ::chat::ExchangedMessage* request, ::chat::Status* response, ::grpc::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::chat::Status>* Chat::Stub::PrepareAsyncsendMessageRaw(::grpc::ClientContext* context, const ::chat::ExchangedMessage& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::chat::Status, ::chat::ExchangedMessage, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_sendMessage_, context, request);
}

::grpc::ClientAsyncResponseReader< ::chat::Status>* Chat::Stub::AsyncsendMessageRaw(::grpc::ClientContext* context, const ::chat::ExchangedMessage& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
::grpc::ClientReader< ::chat::ExchangedMessage>* Chat::Stub::recieveMessageRaw(::grpc::ClientContext* context, const ::chat::UserID& request) {
...
void Chat::Stub::async::recieveMessage(::grpc::ClientContext* context, const ::chat::UserID* request, ::grpc::ClientReadReactor< ::chat::ExchangedMessage>* reactor) {
...
::grpc::ClientAsyncReader< ::chat::ExchangedMessage>* Chat::Stub::AsyncrecieveMessageRaw(::grpc::ClientContext* context, const ::chat::UserID& request, ::grpc::CompletionQueue* cq, void* tag) {
...
::grpc::ClientAsyncReader< ::chat::ExchangedMessage>* Chat::Stub::PrepareAsyncrecieveMessageRaw(::grpc::ClientContext* context, const ::chat::UserID& request, ::grpc::CompletionQueue* cq) {
...
Chat::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      Chat_method_names[2],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< Chat::Service, ::chat::ReadMessage, ::chat::Status, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](Chat::Service* service,
             ::grpc::ServerContext* ctx,
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      Chat_method_names[3],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< Chat::Service, ::chat::ChatData, ::chat::Status, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](Chat::Service* service,
             ::grpc::ServerContext* ctx,
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      Chat_method_names[5],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< Chat::Service, ::chat::ExchangedMessage, ::chat::Status, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](Chat::Service* service,
             ::grpc::ServerContext* ctx,
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      Chat_method_names[6],
      ::grpc::internal::RpcMethod::SERVER_STREAMING,
      new ::grpc::internal::ServerStreamingHandler< Chat::Service, ::chat::UserID, ::chat::ExchangedMessage>(
          [](Chat::Service* service,
             ::grpc::ServerContext* ctx,
             const ::chat::UserID* req,
...
::grpc::Status Chat::Service::readMessage(::grpc::ServerContext* context, const ::chat::ReadMessage* request, ::chat::Status* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
::grpc::Status Chat::Service::editChat(::grpc::ServerContext* context, const ::chat::ChatData* request, ::chat::Status* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
::grpc::Status Chat::Service::sendMessage(::grpc::ServerContext* context, const ::chat::ExchangedMessage* request, ::chat::Status* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
::grpc::Status Chat::Service::recieveMessage(::grpc::ServerContext* context, const ::chat::UserID* request, ::grpc::ServerWriter< ::chat::ExchangedMessage>* writer) {
  (void) context;
  (void) request;
  (void) writer;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
