...
class UserInfo final :
 ...
 public:
  ...
  // repeated string chats = 5;
  int chats_size() const;
  private:
  int _internal_chats_size() const;
  public:
  void clear_chats();
  const std::string& chats(int index) const;
  std::string* mutable_chats(int index);
  void set_chats(int index, const std::string& value);
  void set_chats(int index, std::string&& value);
  void set_chats(int index, const char* value);
  void set_chats(int index, const char* value, size_t size);
  std::string* add_chats();
  void add_chats(const std::string& value);
  void add_chats(std::string&& value);
  void add_chats(const char* value);
  void add_chats(const char* value, size_t size);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>& chats() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>* mutable_chats();
  private:
  const std::string& _internal_chats(int index) const;
  std::string* _internal_add_chats();
  public:
 ...
 private:
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string> chats_;
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr user_id_;
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr name_;
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr nickname_;
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr photo_;
...
inline std::string* UserInfo::mutable_user_id() {
  std::string* _s = _internal_mutable_user_id();
  // @@protoc_insertion_point(field_mutable:user.UserInfo.user_id)
  return _s;
}
...
inline std::string* UserInfo::release_user_id() {
  // @@protoc_insertion_point(field_release:user.UserInfo.user_id)
  return _impl_.user_id_.Release();
}
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:user.UserInfo.user_id)
}
...
// string photo = 4;
inline void UserInfo::clear_photo() {
  _impl_.photo_.ClearToEmpty();
}
inline const std::string& UserInfo::photo() const {
  // @@protoc_insertion_point(field_get:user.UserInfo.photo)
  return _internal_photo();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void UserInfo::set_photo(ArgT0&& arg0, ArgT... args) {
 
 _impl_.photo_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:user.UserInfo.photo)
}
inline std::string* UserInfo::mutable_photo() {
  std::string* _s = _internal_mutable_photo();
  // @@protoc_insertion_point(field_mutable:user.UserInfo.photo)
  return _s;
}
inline const std::string& UserInfo::_internal_photo() const {
  return _impl_.photo_.Get();
}
inline void UserInfo::_internal_set_photo(const std::string& value) {
  
  _impl_.photo_.Set(value, GetArenaForAllocation());
}
inline std::string* UserInfo::_internal_mutable_photo() {
  
  return _impl_.photo_.Mutable(GetArenaForAllocation());
}
inline std::string* UserInfo::release_photo() {
  // @@protoc_insertion_point(field_release:user.UserInfo.photo)
  return _impl_.photo_.Release();
}
inline void UserInfo::set_allocated_photo(std::string* photo) {
  if (photo != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:user.UserInfo.photo)
}

// repeated string chats = 5;
inline int UserInfo::_internal_chats_size() const {
  return _impl_.chats_.size();
}
inline int UserInfo::chats_size() const {
  return _internal_chats_size();
}
inline void UserInfo::clear_chats() {
  _impl_.chats_.Clear();
}
inline std::string* UserInfo::add_chats() {
  std::string* _s = _internal_add_chats();
  // @@protoc_insertion_point(field_add_mutable:user.UserInfo.chats)
  return _s;
}
inline const std::string& UserInfo::_internal_chats(int index) const {
  return _impl_.chats_.Get(index);
}
inline const std::string& UserInfo::chats(int index) const {
  // @@protoc_insertion_point(field_get:user.UserInfo.chats)
  return _internal_chats(index);
}
inline std::string* UserInfo::mutable_chats(int index) {
  // @@protoc_insertion_point(field_mutable:user.UserInfo.chats)
  return _impl_.chats_.Mutable(index);
}
inline void UserInfo::set_chats(int index, const std::string& value) {
  _impl_.chats_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set:user.UserInfo.chats)
}
inline void UserInfo::set_chats(int index, std::string&& value) {
  _impl_.chats_.Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:user.UserInfo.chats)
}
inline void UserInfo::set_chats(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.chats_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:user.UserInfo.chats)
}
inline void UserInfo::set_chats(int index, const char* value, size_t size) {
  _impl_.chats_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:user.UserInfo.chats)
}
inline std::string* UserInfo::_internal_add_chats() {
  return _impl_.chats_.Add();
}
inline void UserInfo::add_chats(const std::string& value) {
  _impl_.chats_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:user.UserInfo.chats)
}
inline void UserInfo::add_chats(std::string&& value) {
  _impl_.chats_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:user.UserInfo.chats)
}
inline void UserInfo::add_chats(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.chats_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:user.UserInfo.chats)
}
inline void UserInfo::add_chats(const char* value, size_t size) {
  _impl_.chats_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:user.UserInfo.chats)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
UserInfo::chats() const {
  // @@protoc_insertion_point(field_list:user.UserInfo.chats)
  return _impl_.chats_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
UserInfo::mutable_chats() {
  // @@protoc_insertion_point(field_mutable_list:user.UserInfo.chats)
  return &_impl_.chats_;
}
...
inline const std::string& UserInfo::password() const {
  // @@protoc_insertion_point(field_get:user.UserInfo.password)
  return _internal_password();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void UserInfo::set_password(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.password_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:user.UserInfo.password)
}
inline std::string* UserInfo::mutable_password() {
  std::string* _s = _internal_mutable_password();
  // @@protoc_insertion_point(field_mutable:user.UserInfo.password)
  return _s;
}
...
inline std::string* UserInfo::release_password() {
  // @@protoc_insertion_point(field_release:user.UserInfo.password)
  return _impl_.password_.Release();
}
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:user.UserInfo.password)
}
