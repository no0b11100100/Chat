...
template<> ::chat::Status* Arena::CreateMaybeMessage<::chat::Status>(Arena*);
...
class Status final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:chat.Status) */ {
 public:
...
// string sender_id = 3;
inline void ExchangedMessage::clear_sender_id() {
  _impl_.sender_id_.ClearToEmpty();
}
inline const std::string& ExchangedMessage::sender_id() const {
  // @@protoc_insertion_point(field_get:chat.ExchangedMessage.sender_id)
  return _internal_sender_id();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ExchangedMessage::set_sender_id(ArgT0&& arg0, ArgT... args) {
 
 _impl_.sender_id_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:chat.ExchangedMessage.sender_id)
}
inline std::string* ExchangedMessage::mutable_sender_id() {
  std::string* _s = _internal_mutable_sender_id();
  // @@protoc_insertion_point(field_mutable:chat.ExchangedMessage.sender_id)
  return _s;
}
inline const std::string& ExchangedMessage::_internal_sender_id() const {
  return _impl_.sender_id_.Get();
}
inline void ExchangedMessage::_internal_set_sender_id(const std::string& value) {
  
  _impl_.sender_id_.Set(value, GetArenaForAllocation());
}
inline std::string* ExchangedMessage::_internal_mutable_sender_id() {
  
  return _impl_.sender_id_.Mutable(GetArenaForAllocation());
}
inline std::string* ExchangedMessage::release_sender_id() {
  // @@protoc_insertion_point(field_release:chat.ExchangedMessage.sender_id)
  return _impl_.sender_id_.Release();
}
inline void ExchangedMessage::set_allocated_sender_id(std::string* sender_id) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:chat.ExchangedMessage.sender_id)
}
...
inline const std::string& Status::status() const {
  // @@protoc_insertion_point(field_get:chat.Status.status)
...
void Status::set_status(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.status_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:chat.Status.status)
}
inline std::string* Status::mutable_status() {
  std::string* _s = _internal_mutable_status();
  // @@protoc_insertion_point(field_mutable:chat.Status.status)
  return _s;
}
...
inline std::string* Status::release_status() {
  // @@protoc_insertion_point(field_release:chat.Status.status)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:chat.Status.status)
}
