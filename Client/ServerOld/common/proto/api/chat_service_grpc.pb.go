...
type ChatClient interface {
	...
	ReadMessage(ctx context.Context, in *ReadMessage, opts ...grpc.CallOption) (*empty.Empty, error)
	EditChat(ctx context.Context, in *ChatData, opts ...grpc.CallOption) (*empty.Empty, error)
	ChatChanged(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (Chat_ChatChangedClient, error)
	SendMessage(ctx context.Context, in *ExchangedMessage, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *chatClient) ReadMessage(ctx context.Context, in *ReadMessage, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *chatClient) EditChat(ctx context.Context, in *ChatData, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *chatClient) SendMessage(ctx context.Context, in *ExchangedMessage, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type ChatServer interface {
	...
	ReadMessage(context.Context, *ReadMessage) (*empty.Empty, error)
	EditChat(context.Context, *ChatData) (*empty.Empty, error)
	ChatChanged(*empty.Empty, Chat_ChatChangedServer) error
	SendMessage(context.Context, *ExchangedMessage) (*empty.Empty, error)
...
func (UnimplementedChatServer) ReadMessage(context.Context, *ReadMessage) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReadMessage not implemented")
}
func (UnimplementedChatServer) EditChat(context.Context, *ChatData) (*empty.Empty, error) {
...
func (UnimplementedChatServer) SendMessage(context.Context, *ExchangedMessage) (*empty.Empty, error) {
