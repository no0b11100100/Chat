...
static ::_pb::Metadata file_level_metadata_user_5fservice_2eproto[5];
...
const uint32_t TableStruct_user_5fservice_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::user::UserInfo, _impl_.name_),
  PROTOBUF_FIELD_OFFSET(::user::UserInfo, _impl_.nickname_),
  PROTOBUF_FIELD_OFFSET(::user::UserInfo, _impl_.photo_),
  PROTOBUF_FIELD_OFFSET(::user::UserInfo, _impl_.chats_),
  PROTOBUF_FIELD_OFFSET(::user::UserInfo, _impl_.email_),
  PROTOBUF_FIELD_OFFSET(::user::UserInfo, _impl_.password_),
  ~0u,  // no _has_bits_
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 32, -1, -1, sizeof(::user::UserInfo)},
  { 45, -1, -1, sizeof(::user::UserData)},
};
...
const char descriptor_table_protodef_user_5fservice_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "onseStatus\022\025\n\rstatusMessage\030\006 \001(\t\"z\n\010Use"
  "rInfo\022\017\n\007user_id\030\001 \001(\t\022\014\n\004name\030\002 \001(\t\022\020\n\010"
  "nickName\030\003 \001(\t\022\r\n\005photo\030\004 \001(\t\022\r\n\005chats\030\005"
  " \003(\t\022\r\n\005email\030\006 \001(\t\022\020\n\010password\030\007 \001(\t\"\030\n"
  "\010UserData\022\014\n\004json\030\001 \001(\t*#\n\016ResponseStatu"
  "s\022\006\n\002OK\020\000\022\t\n\005Error\020\0012\212\001\n\004User\022&\n\006signIn\022"
  "\014.user.SignIn\032\016.user.Response\022&\n\006signUp\022"
  "\014.user.SignUp\032\016.user.Response\0222\n\010editUse"
  "r\022\016.user.UserData\032\026.google.protobuf.Empt"
  "yB\007Z\005/;apib\006proto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_user_5fservice_2eproto = {
    false, false, 698, descriptor_table_protodef_user_5fservice_2eproto,
    "user_service.proto",
    &descriptor_table_user_5fservice_2eproto_once, descriptor_table_user_5fservice_2eproto_deps, 1, 5,
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "user.UserInfo.user_id"));
        } else
          goto handle_unusual;
        continue;
      // string name = 2;
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "user.UserInfo.name"));
        } else
          goto handle_unusual;
        continue;
      // string nickName = 3;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 34)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "user.UserInfo.photo"));
        } else
          goto handle_unusual;
        continue;
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 42)) {
          ...
          do {
            ptr += 1;
            auto str = _internal_add_chats();
            ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
            CHK_(ptr);
            CHK_(::_pbi::VerifyUTF8(str, "user.UserInfo.chats"));
      ...
      case 7:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 58)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "user.UserInfo.password"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* UserInfo::_InternalSerialize(
  ...
  // repeated string chats = 5;
  for (int i = 0, n = this->_internal_chats_size(); i < n; i++) {
    const auto& s = this->_internal_chats(i);
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
...
// @@protoc_insertion_point(message_byte_size_start:user.UserInfo)
  ...
  // repeated string chats = 5;
  total_size += 1 *
      ::PROTOBUF_NAMESPACE_ID::internal::FromIntSize(_impl_.chats_.size());
  for (int i = 0, n = _impl_.chats_.size(); i < n; i++) {
